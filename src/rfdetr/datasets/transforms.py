...
from rfdetr.datasets.multi_image_augmentations import CopyPaste, MixUp, prepare_multi_image_augmentations
from rfdetr.datasets.tiled_crop import SAHIMaskCrop, TiledCroppingWithMasks
...
def _build_albu_transform(name: str, params: dict[str, Any]) -> alb.BasicTransform:
    ...
    local_transforms = {"SAHIMaskCrop": SAHIMaskCrop, "TiledCroppingWithMasks": TiledCroppingWithMasks}
